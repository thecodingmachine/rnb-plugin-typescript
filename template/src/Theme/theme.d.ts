...
import {DefaultVariables, Fonts, Gutters, Images, Layout} from "@/Theme/index";
...
export type CommonParams<C> = ThemeVariables & Pick<Theme<typeof fonts,typeof gutters,typeof images,typeof layout, C>, 'Layout' | 'Gutters' | 'Fonts' | 'Images'>
